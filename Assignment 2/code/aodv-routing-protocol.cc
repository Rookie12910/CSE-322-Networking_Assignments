...
#define MAX_CONGESTION_COUNT 4 // ADDED
    ...
    static TypeId tid =
        TypeId("ns3::aodv::RoutingProtocol")
            ...
            .AddAttribute("MyRouteTimeout",
                          ...
                          MakeTimeChecker())
            .AddAttribute("m_congestion_counter",
                          "Number of congestion",
                          UintegerValue(0),
                          MakeUintegerAccessor(&RoutingProtocol::m_congestion_counter),
                          MakeUintegerChecker<uint32_t>())
...
RoutingProtocol::RecvRequest(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src)
{
    ...
    //Added
    if(m_congestion_counter > MAX_CONGESTION_COUNT)
    {
        NS_LOG_DEBUG("Ignoring RREQ due to congestion");
        return;
    }
...
RoutingProtocol::SendReply(const RreqHeader& rreqHeader, const RoutingTableEntry& toOrigin)
{
    ...
    RrepHeader rrepHeader(/*prefixSize=*/0,
                          ...
                          /*lifetime=*/m_myRouteTimeout,1);  ///< 1 is
    Ptr<Packet> packet = Create<Packet>();
    SocketIpTtlTag tag;
...
RoutingProtocol::RecvReply(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address sender)
{
    ...
    RoutingTableEntry newEntry(
        ...
        rrepHeader.get_congestion_flag()); //<MODIFIED
    RoutingTableEntry toDst;
    if (m_routingTable.LookupRoute(dst, toDst))
    {
