...
RrepHeader::RrepHeader(uint8_t prefixSize,
                       ...
                       uint32_t congestion_flag) ///< ADDED
      ...
      m_origin(origin)
{
    ...
    m_congestion_flag = congestion_flag; ///< ADDED
...
RrepHeader::Serialize(Buffer::Iterator i) const
{
    ...
    i.WriteHtonU32(m_congestion_flag); ///< ADDED
...
RrepHeader::Deserialize(Buffer::Iterator start)
{
    ...
    m_congestion_flag = i.ReadNtohU32(); ///< ADDED
...
RrepHeader::Print(std::ostream& os) const
{
    ...
    os << " source ipv4 " << m_origin << " lifetime " << m_lifeTime
       ...
       << " acknowledgment required flag " << (*this).GetAckRequired(); ///< MODIFIED
}
...
// ADDED
void
RrepHeader::set_congestion_flag(uint32_t congestion_flag)
{
...
RrepHeader::operator==(const RrepHeader& o) const
{
    return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize && m_hopCount == o.m_hopCount &&
            ...
            m_lifeTime == o.m_lifeTime && m_congestion_flag == o.m_congestion_flag); ///< MODIFIED
}
