...
class RrepHeader : public Header
{
  public:
    ...
    RrepHeader(uint8_t prefixSize = 0,
               ...
               uint32_t congestion_flag = 0); ///< ADDED
    ...
    void set_congestion_flag(uint32_t congestion_flag); ///< ADDED
    uint32_t get_congestion_flag() const;              ///< ADDED
  ...
  private:
    ...
    uint32_t m_congestion_flag;  ///< ADDED
};
